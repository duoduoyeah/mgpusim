...
import (
	...
	"github.com/sarchlab/mgpusim/v3/benchmarks/dnn/training_benchmarks/macrovgg"
...
var batchSizeFlag = flag.Int("batch-size", 2,
...
func main() {
	...
	benchmark := tinyvgg.NewBenchmark(runner.Driver())
